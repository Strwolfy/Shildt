package Часть_2_Библиотека_Java._24_Обработка_событий;// listing 1
...
class AdapterDemo extends Frame {
  ...
  public AdapterDemo() {
     ...
     addMouseMotionListener(new MyMouseAdapter1(this));
...
class MyMouseAdapter1 extends MouseAdapter {
  ...
  public MyMouseAdapter1(AdapterDemo adapterDemo) {
...
class InnerClassDemo extends Frame {
  String msg = "";
...
class AnonymousInnerClassDemo extends Frame {
  String msg = "";
